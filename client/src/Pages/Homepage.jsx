    ...
    return (
        // <Helmet>
            <div className="min-h-screen bg-gray-100" data-id="1">
                <header className="bg-primary text-white p-4 flex justify-between items-center" data-id="2"><h1 className="text-2xl font-bold" data-id="3">MCQ Test App</h1><div className="flex items-center space-x-4" data-id="4"><button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2" data-id="5">Student</button><button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2" data-id="6">Teacher</button><span className="relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full" data-id="7"><img className="aspect-square h-full w-full" data-id="8" src={placeholder} /></span></div></header>
